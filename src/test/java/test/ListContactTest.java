...
public class ListContactTest {
	...
	String listcoustomerpage = exlRead.getCellData("AddContactInfo", "LISTCUSTOMERHEADDER", 2);
	@Test
	public void validUserShouldBeAbleToAddCustomer() throws InterruptedException {
		...
		ListCustomerPage listcutomerpg = PageFactory.initElements(driver, ListCustomerPage.class);
		listcutomerpg.clickListCustomer();
		//listcutomerpg.verifyListCustomersPage(listcoustomerpage);
		listcutomerpg.varifyFinalPage(fullname);
